...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/gmd:DS_Series/gmd:seriesMetadata">
    <div class="meta-container">
      ...
      <xsl:if
        test="gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString != ''">
        <h2 class="meta-title">
          <xsl:value-of
      ...
      <div class="meta-record">
        ...
        <xsl:if
          test="gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:abstract/gco:CharacterString != ''">
                  ...
                  <span style="display:inline">
                    <xsl:call-template name="trim-last-word">
                      <xsl:with-param name="in"
                        select="substring(gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:abstract/gco:CharacterString, 1, 400)"
                      />
                    </xsl:call-template>
                    <a href="#"
                      onclick="jQuery(this).parent().parent().children().toggle(); return false">
        ...
        <xsl:if test="gmi:MI_Metadata/gmd:distributionInfo/gmd:MD_Distribution != ''">
          <div class="meta-resources">
            <dl>
              ...
              <xsl:for-each
                select="gmi:MI_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorTransferOptions">
                <xsl:choose>
              ...
              <xsl:for-each
                select="gmi:MI_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions">
                <div class="meta-resource">
                  <dd>
                    <a
                      href="{normalize-space(gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:linkage/gmd:URL)}"
